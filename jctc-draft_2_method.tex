...
\begin{figure}
    ...
    \begin{flushleft}\small 
        ...
        and azimuthal quantum number $m=0$ (Eq.
        \eqref{eq:psi2D00-wave-function}). (b) Excited state $\PsiTwoD_{1,0}$
        with $n=1, m=0$ (Eq. \eqref{eq:psi2D10-wave-function}). In both, the
        upper row shows the real part of the wave function in real-space, and
        the lower row shows the real part in k-space. Both (a) and (b) have
...
\begin{figure}
    ...
    \begin{flushleft}\small
        ...
        \eqref{eq:psi2D11-wave-function}). The upper row shows the real part of
        the wave function in real-space, and the lower row shows the real part
        in k-space. The wave function value at the origin is zero.
    \end{flushleft}
\end{figure}
