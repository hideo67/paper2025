...
For the 1D model, we utilize the analytical solutions provided by Loudon
...
\begin{figure}[ht]
    ...
    states. To apply the corresponding phase rotation for each state, eight Rz
    gates act on the target qubit $t$, where $\mathrm{R}_k$ denotes
    ...
    register. This sign-flipping mechanism relies on the property of the Gray
...
proportional to $-1/r$. Thus, the phase diverges at the point where the nuclear
and electronic coordinates coincide.
...
constrained motion. For instance, setting $\Delta=\sqrt{2}$ in a 1D hydrogen
atom model yields the ground-state energy eigenvalue of $-0.5\ \mathrm{a.u.}$,
which is identical to that of the 3D hydrogen atom
