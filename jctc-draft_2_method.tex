...
\end{equation}
the initial wave function of the system, is expressed as
\begin{equation}
...
\begin{figure}
    ...
    \begin{flushleft}\small 
        ...
        (d) Real part of the wave function in k-space for the same state. Both
        (a) and (c) have non-zero wave function values at the origin.
    \end{flushleft}
\end{figure}
...
as a means to drastically reduce the number of ancilla qubits, which can make
a significant difference in small-scale models.
...
However, because the solution for the 1D model wavefunction has zero amplitude
at the origin, assigning any arbitrary finite potential value at the singularity
...
them with the results for the local average potential described at the preceding
section.
