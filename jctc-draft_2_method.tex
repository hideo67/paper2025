...
number of qubits is modest, it serves as an extremely effective means to
increase the number of qubits available for the coordinate register by reducing
the number of ancilla qubits. By adopting the UCRZ circuit, we achieved a
complete quantum circuit simulation of a 2D model on an emulator in this study.
