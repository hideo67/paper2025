...
method formulated in Section \nameref{sec:method}. First, in Section
...
in Section \nameref{subsec:parameter-selection-for-minimum-error-results}, we show
...
parameters derived in Section \nameref{sec:parameter-selection-for-minimum-error},
...
in Section \nameref{sec:coulomb-potential-handling}, using the local average
...
Section \nameref{sec:coulomb-potential-handling}, which derived $\reff \approx
...
Section \nameref{sec:parameter-selection-for-minimum-error}. First, we describe the
