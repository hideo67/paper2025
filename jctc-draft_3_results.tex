...
The configuration using UCRZ (Uniformly Controlled Rotation Z) circuits for
calculating the Coulomb potential stayed within the emulator's limits for the 1D
and 2D models, but did not fit for the 3D model.
