...
\begin{figure}[ht]
    ...
    (a),(b),(c) Required number of qubits in 1D-3D models. The arithmetic circuit stays
    within the limit (red horizontal line) only in 1D (7 bits or less), while the
    ...
    (d),(e),(f) Number of 2-qubit gates required for 1000 steps of time evolution.
...
set the effective radius to $\reff = \deltar/a$ and evaluated the calculated
...
(Figures \ref{subfig:trotter-error-2d-0-0-6b-t1} -
\ref{subfig:trotter-error-2d-1-0-9b-t1}), no distinct difference in accuracy due
...
quantum number of $m=1$ (Figures \ref{subfig:trotter-error-2d-1-1-6b-t1} -
\ref{subfig:trotter-error-2d-1-1-9b-t1}), a clear difference in accuracy between
