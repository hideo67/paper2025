...
\begin{figure}[ht]
    ...
    \begin{subcaptionblock}[T][][t]{0.3\columnwidth}
        ...
        \caption{Overall view of the circuit}
    ...
    \begin{subcaptionblock}[T][][t]{0.42\columnwidth}
        ...
        \caption{Inside the time evolution circuit $\Thetae$}
...
\begin{figure}[ht]
    ...
    \begin{flushleft}\small 
        ...
        (a) shows the evaluation results for the 1D model $\PsiOneD_1$, and (b) and (c) show the results for the 2D model's $\PsiTwoD_{0,0}$ and $\PsiTwoD_{1,0}$, respectively. (A1) to (C1) show the real part values of the wave function at the intercept $y=0$ and the computational domain boundaries ($\pm L/2$) corresponding to the selected $\deltar$. (A2) to (C2) plot the discretization error and cutoff error individually, and (A3) to (C3) show their sum. The point where this sum of errors is minimized is the point of trade-off equilibrium, giving the optimal $\deltar$.
