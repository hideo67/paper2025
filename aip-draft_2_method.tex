...
\begin{table}
    ...
    \begin{ruledtabular}\begin{tabular}{cl}
        ...
        $L$ & Length in one dimension of the computational unit cell \\
...
\begin{figure}
    ...
    \begin{flushleft}\small 
        ...
        (b) Real part of the wave function in k-space for the same state. (c)
        Real part of the wave function in real-space for the excited state
        $\PsiTwoD_{1,0}$ with $n=1, m=0$ (Eq. \eqref{eq:psi2D10-wave-function}).
        (d) Real part of the wave function in k-space for the same state. The
        qubit count for coordinates $n_b=6$ for all graphs. Both (a) and (c)
        have non-zero wave function values at the origin.
    \end{flushleft}
\end{figure}
...
coordinates of nuclei by a half-grid spacing ($\deltar/2$)
