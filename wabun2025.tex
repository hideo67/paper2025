...
本章の評価では水素原子の一次元と二次元のモデルの時間に依存しないシュレディンガー
...
シミュレーションは一次元のモデルと二次元のモデルに対して行うので、それぞれのモデルの
解析解を以下に示す。
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{chap_circuit_evaluation_figs/analytic1D/t_00.000.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/classic2D/6b_n0_m0/t_00.000_3d-qp.png}
        \caption{波動関数 $\PsiTwoD_{0,0}$}
        \label{subfig:initial-wavefunction-2d-0-0}
    \end{subfigure}
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/classic2D/6b_n1_m0/t_00.000_3d-qp.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.45\columnwidth]{chap_circuit_evaluation_figs/classic2D/6b_n1_m1/t_00.000_3d-qp.png}
...
\begin{figure}[ht]
    ...
    \begin{subcaptionblock}[T][][t]{0.3\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{chap_circuit_evaluation_figs/arith1D/circuit.png}
        \caption{回路の全体像}
        \label{subfig:circuit-1d-arith-overall}
    \end{subcaptionblock}
    \begin{subcaptionblock}[T][][t]{0.42\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{chap_circuit_evaluation_figs/arith1D/elec_motion.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\textwidth]{chap_circuit_evaluation_figs/arith1D/elec_potential_arithmetic.png}
...
\begin{figure}[ht]
    ...
    \begin{subcaptionblock}[T][][t]{0.3\columnwidth}
        \centering
        \includegraphics[width=\textwidth]{chap_circuit_evaluation_figs/ucrz2D/circuit.png}
        \caption{シミュレータ全体}
        \label{subfig:circuit-2d-ucrz-overall}
    \end{subcaptionblock}
    \begin{subcaptionblock}[T][][t]{0.52\columnwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{chap_circuit_evaluation_figs/ucrz2D/elec_motion.png}
        \caption{時間発展回路 $\Thetae$ の内部}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=15cm]{chap_circuit_evaluation_figs/hamiltonian-gatecount.png}
    \caption{回路規模}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{chap_circuit_evaluation_figs/circuit-size-qubits.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/compare_energy/compare_energy_h2D_TO2_r0lim_0_0.png}
        \caption{$\PsiTwoD_{0,0}$}
        \label{subfig:Ha1-energy-0-0}
    \end{subfigure}
    \begin{subfigure}{0.47\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/compare_energy/compare_energy_h2D_TO2_r0lim_1_0.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/compare_energy/compare_energy_h2D_TO2_rofs_0_0.png}
        \caption{$\PsiTwoD_{0,0}$}
        \label{subfig:Ha2-energy-0-0}
    \end{subfigure}
    \begin{subfigure}{0.47\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/compare_energy/compare_energy_h2D_TO2_rofs_1_0.png}
        \caption{$\PsiTwoD_{1,0}$}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{1.0\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{chap_circuit_evaluation_figs/dq_tradeoff/eval1d_dq.png}
        \caption{1次元モデル $\PsiOneD_1$}
        \label{subfig:dq-tradeoff-1d}
    \end{subfigure}
    \begin{subfigure}{1.0\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{chap_circuit_evaluation_figs/dq_tradeoff/eval2d_dq_geom_0_0.png}
        \caption{2次元モデル $\PsiTwoD_{0,0}$}
        \label{subfig:dq-tradeoff-2d-0-0}
    \end{subfigure}
    \begin{subfigure}{1.0\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{chap_circuit_evaluation_figs/dq_tradeoff/eval2d_dq_geom_1_0.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n0_m0_6b_t1.0.png}
        \caption{$\PsiTwoD_{0,0}, \nb=6, t=1.0$}
        \label{subfig:trotter-error-2d-0-0-6b-t1}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n0_m0_9b_t1.0.png}
        \caption{$\PsiTwoD_{0,0}, \nb=9, t=1.0$}
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m0_6b_t1.0.png}
        \caption{$\PsiTwoD_{1,0}, \nb=6, t=1.0$}
        \label{subfig:trotter-error-2d-1-0-6b-t1}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m0_9b_t1.0.png}
        \caption{$\PsiTwoD_{1,0}, \nb=9, t=1.0$}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m1_6b_t1.0.png}
        \caption{$\PsiTwoD_{1,1}, \nb=6, t=1.0$}
        \label{subfig:trotter-error-2d-1-1-6b-t1}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m1_9b_t1.0.png}
        \caption{$\PsiTwoD_{1,1}, \nb=9, t=1.0$}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n0_m0_6b_t30.png}
        \caption{$\PsiTwoD_{0,0}, \nb=6, t=30.0$}
        \label{subfig:trotter-error-2d-0-0-6b-t30}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n0_m0_9b_t30.png}
        \caption{$\PsiTwoD_{0,0}, \nb=9, t=30.0$}
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m0_6b_t30.png}
        \caption{$\PsiTwoD_{1,0}, \nb=6, t=30.0$}
        \label{subfig:trotter-error-2d-1-0-6b-t30}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m0_9b_t30.png}
        \caption{$\PsiTwoD_{1,0}, \nb=9, t=30.0$}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m1_6b_t30.png}
        \caption{$\PsiTwoD_{1,1}, \nb=6, t=30.0$}
        \label{subfig:trotter-error-2d-1-1-6b-t30}
    \end{subfigure}
    \begin{subfigure}{0.45\columnwidth}
        \centering
        \includegraphics[width=1\columnwidth]{chap_circuit_evaluation_figs/sdt_error/trotter_err_n1_m1_9b_t30.png}
        \caption{$\PsiTwoD_{1,1}, \nb=9, t=30.0$}  
