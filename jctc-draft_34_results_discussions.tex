...
observed between different Trotter orders $\gamma$.
For the 3D hydrogen atom model, Burgarth et al. recently reported that states
with $m=0$ exhibit a cusp at the origin, leading to the divergence of higher
moments of the kinetic energy and thus the loss of the theoretical advantage of
higher-order Trotter decompositions
