...
about one period, are shown in the supplementary material
...
observed between different Trotter orders $\gamma$. Burgarth et al. recently
reported for the 3D hydrogen atom model that states with $m=0$ exhibit a cusp at
the origin, leading to the divergence of higher moments of the kinetic energy
and thus the loss of the theoretical advantage of higher-order Trotter
...
all cases, and the error floor after saturation is reduced by a factor of about
$1/2^3$ when the spatial resolution $\nb$ is increased 3 bits from 6 to 9.
