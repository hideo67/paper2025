...
まず、$\PsiTwoD_{0,0}$に関する式\eqref{eq:delta-1-0-0}を導出する。
...
次に、$\PsiTwoD_{1,0}$に関する式\eqref{eq:delta-1-1-0}を導出する。
...
\label{sec:appendix_derivation_geometric-mean}
