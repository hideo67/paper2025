...
\usepackage[style=chem-acs, articletitle=true, sorting=none]{biblatex}
...
%% custom macros defined for this manuscirpt.
\usepackage{jctc-draft_commands}
...
\date{*Email: hideo.takahashi.qa@hitachi.com}
...
(UCR) circuits were found to be a preferrable choice for calculating the Coulomb
...
\begin{minipage}[b][1.75in]{3.25in}
  \centering
  \includegraphics[width=\linewidth,height=1.75in,keepaspectratio]{paper2025_figs/toc_graphics/toc-graphics.png}
\end{minipage}%
% \rule{0.05in}{1.75in}
