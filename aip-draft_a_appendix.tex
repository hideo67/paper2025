...
\begin{align}
  W_{0,0}
   ...
   &= 2\pi
      \int_{r=0}^{\deltar/2}
      (-1)\frac{1}{r}\left(\frac{q_0^3(0-\abs{0})!}{\pi(0+\abs{0})!}\right)
...
\begin{align}
    ...
    &=\frac{\pi\deltar^2}{4}(-1)-\frac{1}{\reff}
...
\begin{align}
  W_{1,0}
   ...
   &= 2\pi\int_{r=0}^{\deltar/2}
      (-1)\frac{1}{r}\left(\frac{q_0^3(1-\abs{0})!}{\pi(1+\abs{0})!}\right)
      (2q_0r)^{2\abs{0}}\exp(-2q_0r)
      \left[L_{1-\abs{0}}^{2\abs{0}}(2q_0r)\right]^2 r dr\notag\\
...
Solving $W_{1,0}=W_{1,0}^\prime$ yields $\reff$ as follows:
\begin{equation}
q_0^2\left\{\left(1+q_0^2\deltar^2\right)e^{-q_0\deltar}-1\right\}
=-\frac{\deltar^2q_0^3}{4\reff}
\end{equation}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{paper2025_figs/sdt_error/trotter_err_00_10_t30.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{paper2025_figs/sdt_error/trotter_err_11_t30.png}
